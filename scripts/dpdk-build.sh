...
#build_options="-Denable_kmods=true -Dmachine=haswell"
...
# patch for dpdk-20.11 under rocky9.3
if [[ "${dpdkver}" == "20.11.1" && `uname -r |awk -F'-' '{print $1}'` == "5.14.0" ]]; then
    /bin/cp -rf ../patch/dpdk-for-rocky9.3/dpdk-stable-20.11.1 ./
    echo -e "\033[32msucceed to patch rocky9.3\033[0m"
fi
